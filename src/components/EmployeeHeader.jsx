...
import { FaUserCircle, FaSignOutAlt, FaProjectDiagram, FaClipboardList, FaHome } from "react-icons/fa";
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="employeeNavbar">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/employee/projects" style={{ color: "#fff", fontWeight: 500 }}>
                <FaClipboardList style={{ marginRight: 4 }} /> My Projects
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/employee/profile" style={{ color: "#fff", fontWeight: 500 }}>
                <FaUserCircle style={{ marginRight: 4 }} /> Profile
              </Link>
            </li>
          </ul>
          <div className="d-flex align-items-center gap-3">
            <span className="d-flex align-items-center" style={{ color: "#fff", fontWeight: 500, fontSize: "1rem" }}>
